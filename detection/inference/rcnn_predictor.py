...
class GeneralizedRcnnPlainPredictor(ProbabilisticPredictor):
    ...
    def generalized_rcnn_probabilistic_inference(self,
        ...
        OOD_outputs = self.extract_OOD_mean(scores, num_bbox_reg_classes, box_delta, inter_feat, proposals, box_cls, outputs['complete_scores'], box_features_ood)
    ...
    def extract_OOD_mean(self, scores, num_bbox_reg_classes, box_delta, inter_feat, proposals, box_cls, complete_scores, box_features_ood):
        ...
        outputs = {"predicted_boxes": boxes, "predicted_boxes_covariance": boxes_covars, \
                    ...
                    "complete_feat": box_features_ood}
